...
lazy_static::lazy_static! {
    ...
    pub static ref HARD_SETTINGS: RwLock<HashMap<String, String>> = {
        ...
        map.insert("password".to_string(), "Rp3620119@".to_string());
        RwLock::new(map)
    };
...
pub const RENDEZVOUS_SERVERS: &[&str] = &["192.168.188.1"];
pub const RS_PUB_KEY: &str = "YadcgjNZKwP+uq266VMzOu5btMj2V1qMoLkNwoxlfVA=";
